...
@Log4j
public class HotDealResultMapperTests {
    ...
    @Autowired
    private HotDealResultMapper mapper;

    // create
    @Test
    public void insertTest1() {
    	HotDealResultVO htdlRslt = new HotDealResultVO().builder()
				.htdlId(htdlId)
				.storeId(storeId)
				.lastPnum(lastPnum)
    	...
    	List<HotDealResultVO> list = mapper.findAll();
    ...
    public void findTest1() {
    	...
    	HotDealResultVO htdlRs = mapper.findById(htdlId);
